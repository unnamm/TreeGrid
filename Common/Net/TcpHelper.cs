...
namespace Common.Net
{
	public static class TcpHelper
	{
		...
		public static List<TcpRecord> GetAllConnections()
		{
			...
			Win32.GetExtendedTcpTable(IntPtr.Zero, ref tableSize, false, AddressFamily.InterNetwork, Win32.TcpTableClass.OwnerPIDAll);
			...
			Win32.GetExtendedTcpTable(memoryPtr, ref tableSize, false, AddressFamily.InterNetwork, Win32.TcpTableClass.OwnerPIDAll);
			...
			{
				// Get the table row
				Win32.TcpTableRow row = (Win32.TcpTableRow)Marshal.PtrToStructure(tableRowPtr, typeof(Win32.TcpTableRow));
